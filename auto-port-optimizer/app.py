...
with st.sidebar:
    choice = st.radio("Select One:", [
        ...
        "Portfolio EDA & Optimization",  # Corrected spelling
        "Next Steps",
    ])
...
q (Order of the moving average model): This is about the size of the moving average window and is used to smooth out short term fluctuations and highlight longer term trends or cycles in the dataset.
    ...
    if st.button("Predict Stock Close Price"):
        ...
        # Download stock data directly into DataFrame
        stocks = yf.download(stock, start=start_date, end=end_date)
        
        # Directly manipulate the DataFrame
...
if choice == "Portfolio EDA & Optimization":
    ...
    # nasdaq 100 tickers 
    nasdaq_100_tickers = [
    "ATVI", "ADBE", "AMD", "ABNB", "ALXN", "ALGN", "GOOGL", "GOOG", "AMZN", "AEP", 
    "AMGN", "ADI", "ANSS", "AAPL", "AMAT", "ASML", "TEAM", "ADSK", "ADP", "BIDU", 
    "BIIB", "BKNG", "AVGO", "CDNS", "CDW", "CERN", "CHTR", "CHKP", "CTAS", "CSCO", 
    "CTSH", "CMCSA", "CPRT", "COST", "CRWD", "CSX", "DXCM", "DOCU", "DLTR", "EBAY", 
    "EA", "EXC", "FB", "FAST", "FISV", "FOXA", "FOX", "GILD", "IDXX", "ILMN", "INCY", 
    "INTC", "INTU", "ISRG", "JD", "KDP", "KLAC", "LRCX", "LBTYA", "LULU", "MAR", "MRVL", 
    "MTCH", "MELI", "META", "MCHP", "MU", "MSFT", "MRNA", "MNST", "NTES", "NFLX", "NVDA", 
    "NXPI", "ORLY", "PCAR", "PAYX", "PYPL", "PTON", "PEP", "PDD", "QCOM", "REGN", "ROST", 
    "STX", "SIRI", "SWKS", "SPLK", "SBUX", "SNPS", "TMUS", "TSLA", "TXN", "KHC", "TTD", 
    "DIS", "TMO", "TRIP", "VRSK", "VRTX", "WBA", "WDAY", "XEL", "ZM"
    ]
    ...
    options = st.multiselect("Select Stocks For Portfolio", nasdaq_100_tickers)
    ...
    if st.button("Generate Portfolio"):
        ...
        # Use Streamlit's st.pyplot to display the figure
        st.pyplot(fig)
    ...
    if st.button("Compare Your Portfolio to $SPY") and 'w' in st.session_state:
        ...
        # Fetch historical data for the stocks in the portfolio and SPY for benchmarking
        ...
        # Normalize the total portfolio value and SPY to start at the same point for comparison
        ...
        fig.update_layout(
            ...
            yaxis_tickformat='%',  # Format the y-axis ticks as percentages
            legend_title='Legend',
